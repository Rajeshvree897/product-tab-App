<?php
	...
	// if (!isset($_GET['code']))
	// {	
		$permission_url = shopify\authorization_url($_GET['shop'], SHOPIFY_APP_API_KEY, array('read_price_rules','write_price_rules','read_discounts','write_discounts','read_content', 'write_content', 'read_themes', 'write_themes', 'read_script_tags', 'write_script_tags','read_products','read_customers','write_customers','write_products','read_products','read_orders','write_orders','read_inventory','write_inventory'));
