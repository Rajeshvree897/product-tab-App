...
if (mysqli_num_rows($result) <= 0) {
 	$sql = "INSERT INTO $config_table_name VALUES ('','$shop','$store_id','$store_email','$store_owner','$install_date','$access_token','$status')";
} else {
...
$admin_url = "https://$shop/admin/apps/" . SHOPIFY_APP_API_KEY . $app_path . "/" . $redirectURL . "?".PRFX."oauth_token=" . $oauth_token . "&".PRFX."shop=" . $shop;
